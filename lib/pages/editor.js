...
internals.Page.editNewPost = function (driver) {
  ...
  driver.keys('This is a TEST post title ' + new Date());
...
internals.Page.insertMedia = function (driver) {
...
// Create gallery
internals.Page.createGallery = function (driver) {
  this.insertMedia(driver);
